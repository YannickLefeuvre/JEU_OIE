...
import { EntityArrayResponseType, PlateauService } from '../service/plateau.service';
...
export class PlateauComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPlateau): number => this.plateauService.getPlateauIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.plateaus = this.refineData(dataFromBody);
  }
  ...
  protected fillComponentAttributesFromResponseBody(data: IPlateau[] | null): IPlateau[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.plateauService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
