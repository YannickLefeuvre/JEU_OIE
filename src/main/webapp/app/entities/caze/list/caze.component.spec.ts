...
describe('Caze Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'caze', component: CazeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to cazeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCazeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCazeIdentifier).toHaveBeenCalledWith(entity);
